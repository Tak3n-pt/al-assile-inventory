      ...
      {activeTab === 'history' ? (
        ...
        <div className="flex-1 flex flex-col bg-dark-900 border-r border-dark-700/50">
          ...
          <div className="p-4 border-b border-dark-700/50 bg-dark-800/50">
            ...
            {/* Filter Bar */}
            <div className="flex items-center gap-3">
              {/* Tarif selector — price tier for the entire sale */}
              <div className="flex items-center gap-1 bg-dark-800 border border-dark-700 rounded-xl px-2 py-1">
                <span className="text-xs text-dark-400 mr-1">{t('tarif') || 'Tarif'}</span>
                {[1, 2, 3].map(n => (
                  <button
                    key={n}
          ...
          <div className="flex-1 overflow-y-auto p-4 relative">
            {loading && (
              <div className="absolute inset-0 z-10 flex items-center justify-center bg-dark-900/60 backdrop-blur-sm">
